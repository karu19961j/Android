package com.example.karan.textviewsecond;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendToScreen(View view) {
        ...
        EditText et1= (EditText) findViewById(R.id.et1MainScreen);
        EditText et2= (EditText) findViewById(R.id.et2MainScreen);
        String msg1=et1.getText().toString();
        String msg2=et2.getText().toString();
        intent.putExtra("nm",msg1);
